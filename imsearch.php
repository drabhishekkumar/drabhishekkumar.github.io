...
<html prefix="og: http://ogp.me/ns#" lang="en-GB" dir="ltr">
	<head>
		<title>Search - drabhishekkumar</title>
		<meta charset="utf-8" />
		...
		<meta property="og:site_name" content="drabhishekkumar" />
		...
		<link rel="stylesheet" type="text/css" href="imHeader_pluginAppObj_03/custom.css" media="screen, print" /><link rel="stylesheet" type="text/css" href="imHeader_pluginAppObj_08/custom.css" media="screen, print" />
		<link rel="stylesheet" type="text/css" href="pcss/imsearch.css?14-0-4-3-636867141140307358" media="screen,print" />
		...
		<script type="text/javascript" src="imHeader_pluginAppObj_03/main.js"></script><script type="text/javascript" src="imHeader_pluginAppObj_08/main.js"></script>
	...
	<body>
        ...
        </div></div></div></div><div id="imHeader_imMenuObject_06_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_6" class="" > <div id="imHeader_imCellStyleGraphics_6"></div><div id="imHeader_imCellStyle_6" ><div id="imHeader_imMenuObject_06"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
...
Home Page		</a>
	...
	</li><li class="imMnMnMiddle imLevel"><div class="label-wrapper"><div class="label-inner-wrapper"><span class="label">Level 5</span></div></div><ul data-flip-direction="1">
...
Page 1		</a>
	...
	</li></ul></li><li class="imMnMnMiddle imLevel"><div class="label-wrapper"><div class="label-inner-wrapper"><span class="label">Level 4</span></div></div><ul data-flip-direction="1">
	</ul></li><li class="imMnMnMiddle imLevel"><div class="label-wrapper"><div class="label-inner-wrapper"><span class="label">Level 3</span></div></div><ul data-flip-direction="1">
	</ul></li><li class="imMnMnLast imLevel"><div class="label-wrapper"><div class="label-inner-wrapper"><span class="label">Level 2</span></div></div><ul data-flip-direction="1">
...
$(function () {$('#imHeader_imMenuObject_06 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imHeader_imMenuObject_06-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imHeader_imMenuObject_06-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
...
</div></div></div><div id="imHeader_imObjectTitle_07_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_7" class="" > <div id="imHeader_imCellStyleGraphics_7"></div><div id="imHeader_imCellStyle_7" ><div id="imHeader_imObjectTitle_07"><span id ="imHeader_imObjectTitle_07_text" >Accessories</span > </div></div></div></div><div id="imHeader_pluginAppObj_08_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_8" class="" > <div id="imHeader_imCellStyleGraphics_8"></div><div id="imHeader_imCellStyle_8" ><div id="imHeader_pluginAppObj_08">
        ...
        </div></div></div></div><div id="imHeader_imMenuObject_09_wrapper" class="template-object-wrapper"><div id="imHeader_imCell_9" class="" > <div id="imHeader_imCellStyleGraphics_9"></div><div id="imHeader_imCellStyle_9" ><div id="imHeader_imMenuObject_09"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
	<div class="hamburger-menu-background menu-mobile menu-mobile-animated hidden">
		<div class="hamburger-menu-close-button"><span>&times;</span></div>
	</div>
</div>
...
</div></div></div><div id="imStickyBar_imObjectTitle_02_wrapper" class="template-object-wrapper"><div id="imStickyBar_imCell_2" class="" > <div id="imStickyBar_imCellStyleGraphics_2"></div><div id="imStickyBar_imCellStyle_2" ><div id="imStickyBar_imObjectTitle_02"><span id ="imStickyBar_imObjectTitle_02_text" >Accessories</span > </div></div></div></div><div id="imStickyBar_imMenuObject_03_wrapper" class="template-object-wrapper"><div id="imStickyBar_imCell_3" class="" > <div id="imStickyBar_imCellStyleGraphics_3"></div><div id="imStickyBar_imCellStyle_3" ><div id="imStickyBar_imMenuObject_03"><div class="hamburger-button hamburger-component"><div><div><div class="hamburger-bar"></div><div class="hamburger-bar"></div><div class="hamburger-bar"></div></div></div></div><div class="hamburger-menu-background-container hamburger-component">
	<div class="hamburger-menu-background menu-mobile menu-mobile-animated hidden">
		<div class="hamburger-menu-close-button"><span>&times;</span></div>
	</div>
</div>
...
$(function () {$('#imStickyBar_imMenuObject_03 ul li').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imStickyBar_imMenuObject_03-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_11_tab0" style="">
		<div class="text-inner">
			<div style="text-align: right;"><span class="fs10 cf1"><b>Created with WebSite X5</b></span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_15_tab0" style="">
		<div class="text-inner">
			<div><b><span class="fs16 cf1 cb1">policy</span></b></div><div><span class="fs10 cf2"><span style="line-height: 23px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br></span></div><div><span class="fs10 cf2">Phasellus a sagittis massa.</span></div><div><span class="fs10 cf2">Duis non arcu venenatis, cursus ex.</span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_17_tab0" style="">
		<div class="text-inner">
			<div style="text-align: right;"><span class="fs16 cf1"><b>Home</b></span></div><div style="text-align: right;"><span class="fs16 cf1"><b><a href="page-1.html" class="imCssLink" onclick="return x5engine.utils.location('page-1.html', null, false)">Page1</a></b></span></div><div style="text-align: right;"><span class="fs16 cf1"><b><a href="page-2.html" class="imCssLink" onclick="return x5engine.utils.location('page-2.html', null, false)">Page2</a></b></span></div><div style="text-align: right;"><span class="fs16 cf1"><b><a href="page-3.html" class="imCssLink" onclick="return x5engine.utils.location('page-3.html', null, false)">Page3</a></b></span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_18_tab0" style="">
		<div class="text-inner">
			<div><b><span class="fs16 cf1 cb1">terms</span></b></div><div><span class="fs10 cf2"><span style="line-height: 23px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br></span></div><div><span class="fs10 cf2">Phasellus a sagittis massa.</span></div><div><span class="fs10 cf2">Duis non arcu venenatis, cursus ex.</span></div>
		</div>
	</div>
	...
	<div class="text-tab-content"  id="imFooter_imTextObject_19_tab0" style="">
		<div class="text-inner">
			<div><b><span class="fs16 cf1 cb1">style</span></b></div><div><span class="fs10 cf2"><span style="line-height: 23px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span><br></span></div><div><span class="fs10 cf2">Phasellus a sagittis massa.</span></div><div><span class="fs10 cf2">Duis non arcu venenatis, cursus ex.</span></div>
		</div>
	</div>
